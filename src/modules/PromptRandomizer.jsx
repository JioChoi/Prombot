    ...
    return (
        <div>
            ...
            <ModuleBody>
                ...
                <Textarea configKey="prompt_search" label="Search Tags" placeholder="Tags to search for the prompt randomization" autocomplete="on" height="80px" disableButton={true} disableKey="search_disabled" />
                
                <Toggles disableKey="search_disabled" items={[
