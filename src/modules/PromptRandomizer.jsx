...
export default function PromptRandomizer() {
    return (
        <div>
            ...
            <ModuleBody>
                <Textarea configKey="prompt_beg" label="Begining Prompt" placeholder="Tags to put at the beginning" autocomplete="on" height="80px"/>
                <Textarea configKey="prompt_search" label="Search Tags" placeholder="Tags to search for the prompt randomization" autocomplete="on" height="86px"/>
